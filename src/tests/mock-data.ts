export const MockData = {
  ...
  results: [
    ...
    {
      adult: false,
      backdrop_path: '/vRtaOcBs5ViVjquEtAGpzsqIjFE.jpg',
      genre_ids: [10749],
      id: 818809,
      original_language: 'en',
      original_title: 'A Cinderella Story: Starstruck',
      overview:
      ...
      popularity: 95.136,
      poster_path: '/sXJWIqJbwkjtJLKbmUv0vlflhra.jpg',
      release_date: '2021-06-29',
      title: 'A Cinderella Story: Starstruck',
      video: false,
      vote_average: 7.5,
      vote_count: 74,
    },
